...
void testRemoveOccurences(Relation rel)
{
	...
	assert(sb.removeOccurrences(2, 5) == 0);
	assert(sb.removeOccurrences(2, -1) == 0);

	assert(sb.nrOccurrences(5) == sb.removeOccurrences(8, 5));
	assert(sb.size() == 6);
...
void testAllExtended() {
	...
	testRemoveOccurences(relation3);
}
